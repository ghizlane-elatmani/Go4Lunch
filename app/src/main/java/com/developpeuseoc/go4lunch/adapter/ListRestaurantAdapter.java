...
public class ListRestaurantAdapter extends RecyclerView.Adapter<ListRestaurantAdapter.ListRestaurantViewHolder> {
    ...
    //Constructor
    public ListRestaurantAdapter(List<PlaceAPI> placeDetails, RequestManager glide, String mPosition) {
    ...
    public static class ListRestaurantViewHolder extends RecyclerView.ViewHolder {
        ...
        public void updateWithRestaurantDetails(PlaceAPI.PlaceDetailsResult result, RequestManager glide, String mPosition) {
        ...
        private void restaurantDistance(String startLocation, PlaceAPI.Location endLocation) {
        ...
        //For rating
        private void restaurantRating(PlaceAPI.PlaceDetailsResult result) {
        ...
        @SuppressLint("SetTextI18n")
        private String getHoursInfo(PlaceAPI.PlaceDetailsResult result) {
            ...
            if (result.getOpeningHours() != null && result.getOpeningHours().getPeriods() != null) {
                try{
                    for (PlaceAPI.Period p : result.getOpeningHours().getPeriods()) {
