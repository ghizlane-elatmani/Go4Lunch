...
import com.developpeuseoc.go4lunch.model.Booking;
...
public class RestaurantsHelper {
    ...
    public static Boolean deleteLike(final String restaurantId, final String userId){
        RestaurantsHelper.getLikeForThisRestaurant(restaurantId).addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            @Override
            public void onComplete(@NonNull Task<DocumentSnapshot> restaurantTask) {
